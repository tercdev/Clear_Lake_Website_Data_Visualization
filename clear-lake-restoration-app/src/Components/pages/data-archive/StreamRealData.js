...
function StreamRealData() {
    ...
    return (
        ...
        {!creekData.isLoading && creekData.data.length == 0 && <p>There is no real time stream data from {startGraphDate.toDateString()} to {endGraphDate.toDateString()}.</p>}
        <p>Real time data is limited to 180 days.</p>
        </center>
    )
}

export default StreamRealData;